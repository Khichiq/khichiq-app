...
import 'widgets/baaea2_item_widget.dart';
...
import 'provider/khichiq_home_default_four_provider.dart';

class KhichiqHomeDefaultFourScreen extends StatefulWidget {
  const KhichiqHomeDefaultFourScreen({Key? key})
      : super(
          key: key,
        );

  @override
  KhichiqHomeDefaultFourScreenState createState() =>
      KhichiqHomeDefaultFourScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => KhichiqHomeDefaultFourProvider(),
      child: KhichiqHomeDefaultFourScreen(),
    );
  }
}

class KhichiqHomeDefaultFourScreenState
    extends State<KhichiqHomeDefaultFourScreen> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Stack(
              alignment: Alignment.topRight,
              children: [
                Selector<KhichiqHomeDefaultFourProvider,
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Consumer<KhichiqHomeDefaultFourProvider>(
              builder: (context, provider, child) {
                return CarouselSlider.builder(
                  ...
                  itemCount: provider
                      .khichiqHomeDefaultFourModelObj.baaea2ItemList.length,
                  itemBuilder: (context, index, realIndex) {
                    Baaea2ItemModel model = provider
                        .khichiqHomeDefaultFourModelObj.baaea2ItemList[index];
                    return Baaea2ItemWidget(
                      model,
                    );
                  },
                );
          ...
          Consumer<KhichiqHomeDefaultFourProvider>(
            builder: (context, provider, child) {
              return SizedBox(
                height: 6.v,

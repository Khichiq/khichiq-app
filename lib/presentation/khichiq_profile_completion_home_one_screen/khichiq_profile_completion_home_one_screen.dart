...
import 'widgets/lineeight2_item_widget.dart';
...
import 'provider/khichiq_profile_completion_home_one_provider.dart';

class KhichiqProfileCompletionHomeOneScreen extends StatefulWidget {
  const KhichiqProfileCompletionHomeOneScreen({Key? key})
      : super(
          key: key,
        );

  @override
  KhichiqProfileCompletionHomeOneScreenState createState() =>
      KhichiqProfileCompletionHomeOneScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => KhichiqProfileCompletionHomeOneProvider(),
      child: KhichiqProfileCompletionHomeOneScreen(),
    );
  }
}

class KhichiqProfileCompletionHomeOneScreenState
    extends State<KhichiqProfileCompletionHomeOneScreen> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                Consumer<KhichiqProfileCompletionHomeOneProvider>(
                  builder: (context, provider, child) {
                    return CarouselSlider.builder(
                      ...
                      itemCount: provider
                          .khichiqProfileCompletionHomeOneModelObj
                          .lineeight2ItemList
                          .length,
                      itemBuilder: (context, index, realIndex) {
                        Lineeight2ItemModel model = provider
                            .khichiqProfileCompletionHomeOneModelObj
                            .lineeight2ItemList[index];
                        return Lineeight2ItemWidget(
                          model,
                        );
                      },
                    );
                ...
                Align(
                  alignment: Alignment.bottomCenter,
                  child: Consumer<KhichiqProfileCompletionHomeOneProvider>(
                    builder: (context, provider, child) {
                      return SizedBox(
                        height: 6.v,
  ...
  /// Section Widget
  Widget _buildSmilee(BuildContext context) {
    return SizedBox(
      height: 127.v,
      width: double.maxFinite,
      child: Stack(
